...
public class ShiroConfig
{
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager)
    {
        ...
        filterChainDefinitionMap.put("/htmlpages/**", "anon");
        ...
        //这个是外部api接口/admin/article/updateV2/locked/1
        filterChainDefinitionMap.put("/api/system/config/getSysConfig", "anon,captchaValidate");
        filterChainDefinitionMap.put("/admin/article/updateV2/**", "anon,captchaValidate");
...
//        cookieRememberMeManager.setCipherKey(Base64.decode("fCq+/xW488hMTCD+cmJ3aQ=="));//这个默认的秘钥导致非常严重的漏洞问题
